...
/** 전체 노트 관리 API와 2차 노트 관리 API에서 공유하는 탭형 Lexical 샘플. */
export default function LexicalSamplePreview({ minHeight = "620px" }: LexicalSamplePreviewProps) {
  const [tab, setTab] = useState<"todo" | "step1">("todo");
