...
export default function AiEditConnectionDialog({ connection, onClose }: AiEditConnectionDialogProps) {
  return (
    <ApiGuideDialogShell
      ...
      description="발급된 1회용 토큰으로 이 문서 하나의 본문만 조회·수정할 수 있습니다."
      copyText={connection}
      onClose={onClose}
      ...
      footer="이 API는 현재 documentId 하나만 대상으로 합니다. content는 기존 Lexical 문서 구조를 유지한 JSON 문자열로 보내고, 저장 전 최신 version을 expectedVersion에 사용하세요. 토큰은 한 번 저장한 뒤 폐기되며 만료 시간 이후에는 사용할 수 없습니다."
    >
