...
public enum ErrorCode {
    ...
    LOT_WORK_ORDER_PRODUCT_MISMATCH(HttpStatus.BAD_REQUEST, "LOT_010", "작업지시 품목과 LOT 제품이 일치하지 않습니다."),
    LOT_WORK_ORDER_NOT_AVAILABLE(HttpStatus.BAD_REQUEST, "LOT_011", "대기 또는 진행 상태의 작업지시에만 새 LOT를 만들 수 있습니다."),
    LOT_WORK_ORDER_QUANTITY_EXCEEDED(HttpStatus.BAD_REQUEST, "LOT_012", "작업지시의 잔여 수량을 초과해 LOT를 등록할 수 없습니다."),
    PRODUCT_NOT_FOUND(HttpStatus.NOT_FOUND, "PRODUCT_001", "제품을 찾을 수 없습니다."),
    PRODUCT_CODE_DUPLICATE(HttpStatus.CONFLICT, "PRODUCT_002", "이미 존재하는 제품 코드입니다."),
    PRODUCT_INACTIVE(HttpStatus.BAD_REQUEST, "PRODUCT_003", "비활성 제품은 신규 LOT 또는 테스트 스펙에 사용할 수 없습니다."),
    ...
    PACKAGE_TEST_PRODUCT_NOT_FOUND(HttpStatus.NOT_FOUND, "PT_001", "P&T 제품을 찾을 수 없습니다."),
    PACKAGE_TEST_SPEC_NOT_FOUND(HttpStatus.NOT_FOUND, "PT_002", "테스트 스펙을 찾을 수 없습니다."),
    PACKAGE_TEST_SPEC_DUPLICATE(HttpStatus.CONFLICT, "PT_003", "같은 제품에 동일한 테스트 스펙 버전이 이미 존재합니다."),
    PACKAGE_TEST_CONDITION_NOT_FOUND(HttpStatus.NOT_FOUND, "PT_004", "검사 조건을 찾을 수 없습니다."),
    PACKAGE_TEST_CONDITION_DUPLICATE(HttpStatus.CONFLICT, "PT_005", "스펙 안에 동일한 검사번호가 이미 존재합니다."),
    PACKAGE_TEST_RANGE_INVALID(HttpStatus.BAD_REQUEST, "PT_006", "범위 검사 조건의 하한·상한을 확인하세요."),
    PACKAGE_TEST_RANGE_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "PT_007", "합격/불합격 검사에는 숫자 범위를 입력할 수 없습니다."),
    PACKAGE_TEST_SPEC_APPROVED_READONLY(HttpStatus.BAD_REQUEST, "PT_008", "승인된 테스트 스펙은 변경할 수 없습니다."),
