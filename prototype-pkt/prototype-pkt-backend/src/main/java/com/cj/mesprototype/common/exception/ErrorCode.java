...
public enum ErrorCode {
    ...
    UPLOAD_FILE_TOO_LARGE(HttpStatus.BAD_REQUEST, "UPLOAD_003", "이미지 파일은 10MB 이하만 업로드할 수 있습니다."),
    UPLOAD_INVALID_OBJECT_KEY(HttpStatus.BAD_REQUEST, "UPLOAD_004", "허용되지 않은 업로드 파일입니다."),
    ...
    LOT_CODE_DUPLICATE(HttpStatus.CONFLICT, "LOT_003", "이미 존재하는 LOT 번호입니다."),
    LOT_PRODUCT_NOT_FOUND(HttpStatus.NOT_FOUND, "LOT_004", "등록할 제품을 찾을 수 없습니다."),
    LOT_PROCESS_NOT_FOUND(HttpStatus.NOT_FOUND, "LOT_005", "등록할 공정을 찾을 수 없습니다."),
    LOT_PROCESS_NOT_IN_PRODUCT_ROUTE(HttpStatus.BAD_REQUEST, "LOT_006", "선택한 제품의 공정 경로에 없는 공정입니다."),
    LOT_NOT_FOUND(HttpStatus.NOT_FOUND, "LOT_007", "LOT를 찾을 수 없습니다."),
    LOT_UPDATE_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "LOT_008", "대기 상태 LOT만 수정할 수 있습니다."),
    LOT_DELETE_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "LOT_009", "대기 상태이며 생산 이력이 없는 LOT만 삭제할 수 있습니다."),
    QUALITY_INSPECTION_NOT_FOUND(HttpStatus.NOT_FOUND, "QC_001", "품질 검사 대상을 찾을 수 없습니다."),
    QUALITY_INSPECTION_INVALID_STATUS(HttpStatus.BAD_REQUEST, "QC_002", "품질 검사 상태 조회 조건이 올바르지 않습니다."),
    QUALITY_INSPECTION_PASS_CRITERIA_NOT_MET(HttpStatus.BAD_REQUEST, "QC_003", "치수 이탈 또는 외관 이상이 있는 제품은 합격 처리할 수 없습니다."),
